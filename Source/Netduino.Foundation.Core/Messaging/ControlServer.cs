...
#else
using VariableList = System.Collections.Generic.List<Netduino.Foundation.Messaging.Variable>;
using CommandList = System.Collections.Generic.List<Netduino.Foundation.Messaging.Command>;
#endif


namespace Netduino.Foundation.Messaging
{
	/// <summary>
